...
class PreferencesService {
  ...
  static String get displayName => settings.displayName;

  /// Update display name
  static Future<void> updateDisplayName(String name) async {
    await updateSettings(settings.copyWith(displayName: name));
  }

  /// Get notifications enabled state
  static bool get notificationsEnabled => settings.notificationsEnabled;
